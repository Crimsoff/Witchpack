...
execute at @s run function aj:wp_mandrake/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function aj:wp_mandrake/animations/idle/zzz/apply_frame {frame: $(to_frame)}
