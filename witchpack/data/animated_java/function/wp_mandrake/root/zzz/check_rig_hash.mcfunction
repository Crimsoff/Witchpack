...
function animated_java:wp_mandrake/root/zzz/show_outdated_warning with storage aj:temp args
data modify entity @s data.rigHash set value 'd2025c89ae5435dd00b618f1daebfb74e0dab10268e6e3c31944fab0bf2463bd'
execute on passengers run data merge entity @s {Glowing: 1b, glow_color_override: 16711680}
summon minecraft:text_display ~ ~ ~ { Tags:['aj.global.entity', 'aj.outdated_rig_text_display', 'aj.new'], text:["",{"text":"This rig instance is outdated!\\nIt will not function correctly and should be removed or re-summoned.","color":"red"}], alignment: 'center', billboard: 'vertical', transformation:{ translation:[0f,1f,0f], left_rotation:[0f,0f,0f,1f], right_rotation:[0f,0f,0f,1f], scale:[1f,1f,1f] } }
