...
# Check if hp is 0 or less, or if the bat dies
...
execute as @e[type=player] if score @s c_wp_UUID0 = @n[type=interaction,tag=c_wp_broom_hb,distance=..0.5] c_wp_i_UUID0 if score @s c_wp_UUID1 = @n[type=interaction,tag=c_wp_broom_hb,distance=..0.5] c_wp_i_UUID1 if score @s c_wp_UUID2 = @n[type=interaction,tag=c_wp_broom_hb,distance=..0.5] c_wp_i_UUID2 if score @s c_wp_UUID3 = @n[type=interaction,tag=c_wp_broom_hb,distance=..0.5] c_wp_i_UUID3 positioned ~ ~0.5 ~ run ride @s mount @n[type=item_display,tag=c_wp_broom_display,distance=..1]