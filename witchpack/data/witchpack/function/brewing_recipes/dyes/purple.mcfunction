execute as @n[type=item,distance=..0.5] if data entity @s {Item:{id:"minecraft:purple_dye"}} run function witchpack:rituals/remove_item


scoreboard players set @s c_wp_color 8991416
