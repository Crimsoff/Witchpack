...
execute as @e[type=item,nbt={Item:{id:"minecraft:cobweb"}},limit=1,sort=nearest,tag=!c_wp_lower_count] run data modify entity @s PickupDelay set value 100
execute as @e[type=item,nbt={Item:{id:"minecraft:cobweb"}},limit=1,sort=nearest,tag=!c_wp_lower_count] run scoreboard players set @s c_wp_removal_delay 20
execute as @e[type=item,nbt={Item:{id:"minecraft:cobweb"}},limit=1,sort=nearest,tag=!c_wp_lower_count] run tag @s add c_wp_lower_count

execute as @e[type=item,nbt={Item:{id:"minecraft:soul_sand"}},limit=1,sort=nearest,tag=!c_wp_lower_count] run data modify entity @s PickupDelay set value 100
execute as @e[type=item,nbt={Item:{id:"minecraft:soul_sand"}},limit=1,sort=nearest,tag=!c_wp_lower_count] run scoreboard players set @s c_wp_removal_delay 40
execute as @e[type=item,nbt={Item:{id:"minecraft:soul_sand"}},limit=1,sort=nearest,tag=!c_wp_lower_count] run tag @s add c_wp_lower_count
...
tag @s add c_wp_ritual_slowness_curse