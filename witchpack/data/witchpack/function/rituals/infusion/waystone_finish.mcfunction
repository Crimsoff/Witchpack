...
data modify entity @n[type=item,tag=c_wp_waystone_init,distance=..64] Item.components."minecraft:custom_data".x set from entity @s block_pos[0]
data modify entity @n[type=item,tag=c_wp_waystone_init,distance=..64] Item.components."minecraft:custom_data".y set from entity @s block_pos[1]
data modify entity @n[type=item,tag=c_wp_waystone_init,distance=..64] Item.components."minecraft:custom_data".z set from entity @s block_pos[2]
