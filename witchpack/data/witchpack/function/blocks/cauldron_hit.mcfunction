execute on vehicle run function aj:wp_cauldron/animations/attacked/play
...
execute if score @s c_wp_hp matches ..0 on vehicle run function aj:wp_cauldron/remove/this
