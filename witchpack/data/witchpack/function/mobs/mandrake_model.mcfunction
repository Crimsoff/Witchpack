execute if predicate witchpack:deadornovehicle run return run function aj:wp_mandrake/animations/death/play
...
execute if entity @s[tag=!aj.wp_mandrake.animation.scream.playing] if score @s c_wp_e_attack_cd matches ..0 run function aj:wp_mandrake/animations/scream/play_exclusive
